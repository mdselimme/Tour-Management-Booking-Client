...
const Bookings = () => {
  ...
  const { id } = useParams();
  const { data, isLoading, isError } = useAllToursQuery({ _id: id });
  ...
  const handleBooking = async () => {
    ...
    const toastId = toast.loading("Booking adding ....");
    try {
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  {localDate(tourData?.startDate as string)} to{" "}
                  {localDate(tourData?.endDate as string)}
                </div>
                <div>
